...
-- 2 Branches · 12 Rooms · Hours · Activities · Tasks · Vouchers
-- ============================================================
...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', 'ויקינגים – חץ וקשת', 90, 15),
...
-- Skip ויקינגים (room 7) — 90-min activity, handled separately
